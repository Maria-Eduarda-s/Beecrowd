...
Saída
A saída deverá ser uma mensagem conforme o exemplo fornecido abaixo, lembrando de deixar um espaço após os dois pontos e um espaço após o "R$". O valor deverá 
...
for _ in range(2):
    codigo, num, valor_unitario = input().split()
    num = int(num)
    valor_unitario = float(valor_unitario)
    
    total_pagar += num * valor_unitario
