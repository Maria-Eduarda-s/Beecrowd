 ...
 *deve-se fornecer o tempo gasto na viagem (em horas) e a velocidade média durante a
 * mesma (em km/h). Assim, pode-se obter distância percorrida e, em seguida, 
...
public class GastoDeCombustivel_1017 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.printf("%.3f%n", (hora * velocidade / 12));
