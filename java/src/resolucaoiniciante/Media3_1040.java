 ...
 * 4 e 1, respectivamente, para cada uma destas notas e mostre esta média acompanhada
...
ser impressas conforme a descrição do problema. Não esqueça de imprimir o enter 
...
public class Media3_1040 {
	...
	public static void main(String[] args) throws IOException {
		...
		if (media >= 5.0 && media < 7.0) {
			...
			float total = (media + exame) / 2;

			if (total >= 5.00) {
				System.out.println("Aluno aprovado.");
				System.out.printf("Media final: %.1f%n", total);
			}
